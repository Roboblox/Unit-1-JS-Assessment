 ...
 */
function getSecondStarshipName(character, starships) {
  // TODO: Add your code here.
  for (let i = 0; i < character.starships.length; i++) {
    return character.starships[i];
  }
}
...
function getSummary(character) {
  // TODO: Add your code here.
  return `${character.name}, ${character.height}cm,${character.mass}kg. Featured in  films.`;
}
